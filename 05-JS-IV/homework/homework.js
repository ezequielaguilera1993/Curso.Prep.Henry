...
objeto[property]=null //con el punto no anda aca, ni siqueire pasandolo a string, si se usa variables va con [ entonces ]
return objeto
...
function invocarMetodo(objeto, metodo) {
  ...
  // Invoca ese método
  // Nada necesita ser devuelto (s"returned")
  // Tu código:
...
//va entre comillas porque es un string la clave, el valor puede ser cualquier cosa
...
function tienePropiedad(objeto, propiedad) {
  ...
  // Tu código:
for (x in objeto){
  if (x===propiedad) return true
}

return false

/**Tambien se puede hacer asi 
 if(usuario[propiedad]){return true}  //no hace falta comillas porque ya es un String
  else {return false}
 */
